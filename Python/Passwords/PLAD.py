...
import createPLAD, deletePLAD, writePLAD, searchPLAD, encryptPLAD, decryptPLAD, set_keys
from sys import argv

def main():

    with open("dbPLAD.csv", "r") as public_keys:
        ...
        if n == -1:
            ...
            #If the second argument in the comand line is -C it williniciate the process to create a PLAD
                ...
                with open("dbPLAD.csv", "r") as check_db:
                ...
                with open("dbPLAD.csv", "r") as database:
